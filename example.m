...
% add path of Chebfun
Chebfun_idx = 1;
% Chebfun_idx, the way to install Chebfun, include 1 (if you have installed 
% it in advance) and 2 (use unzip and savepath commands)        
% Note that the savepath command above will not work if you don't have
% write permission to the MATLAB system file pathdef.m. You can directly
% download Chebfun (.zip) on its homepage http://www.chebfun.org/download/
% or Github https://github.com/chebfun/chebfun.git and add its path
% manually instead.
switch Chebfun_idx
    case 1
        % add Chebfun's path manually
        fprintf('It is wise for you to install Chebfun in advance\n')
    case 2
