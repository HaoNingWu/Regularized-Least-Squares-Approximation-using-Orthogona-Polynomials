...
switch example_idx
    ...
    case 2
        G = triangularPulse(-.5,.5,f)+rectangularPulse(-.5,.5,f)+triangularPulse(-1,-.5,f)+triangularPulse(.5,1,f)+triangularPulse(-.5,0,f)+triangularPulse(0,.5,f);
        GG = triangularPulse(-.5,.5,ff)+rectangularPulse(-.5,.5,ff)+triangularPulse(-1,-.5,ff)+triangularPulse(.5,1,ff)+triangularPulse(-.5,0,ff)+triangularPulse(0,.5,ff);
    case 3    
